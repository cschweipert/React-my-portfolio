...
function Projects() {
    ...
    <h2>Project.</h2>
    <p>This project was inpired by bears. I live in a small mountain town in the foothills of the San Juans in Colorado. We love our bears and want to keep them safe. If we don't have time to pick our fruit, the bears will come to town to pick it
